...
func (c *dojoClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := grpc.Invoke(ctx, "/dojo.Dojo/Hello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Dojo_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DojoServer).Hello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dojo.Dojo/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DojoServer).Hello(ctx, req.(*HelloRequest))
	}
...
var fileDescriptor0 = []byte{
	...
	0x53, 0x8b, 0x8b, 0x13, 0xd3, 0x61, 0xea, 0x60, 0x5c, 0x23, 0x0b, 0x2e, 0x16, 0x97, 0xfc, 0xac,
	0x7c, 0x21, 0x03, 0x2e, 0x56, 0xb0, 0x16, 0x21, 0x21, 0x3d, 0x90, 0x35, 0x7a, 0xc8, 0x76, 0x48,
	0x09, 0xa3, 0x88, 0x41, 0xcc, 0x4c, 0x62, 0x03, 0xbb, 0xca, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0xa5, 0x67, 0xd1, 0x15, 0xa5, 0x00, 0x00, 0x00,
}
